 ...
 */
final class Version20211027101658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, room_id INT DEFAULT NULL, name VARCHAR(45) NOT NULL, nb_place INT NOT NULL, description LONGTEXT DEFAULT NULL, location_id INT DEFAULT NULL, INDEX IDX_729F519B54177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
